...
from min_bpe_tokenizer import MyBasicTokenizer, MyRegexTokenizer
# -----------------------------------------------------------------------------
# common test data
...
@pytest.mark.parametrize("tokenizer_factory", [MyBasicTokenizer, RegexTokenizer, GPT4Tokenizer])
...
@pytest.mark.parametrize("tokenizer_factory", [MyBasicTokenizer, MyRegexTokenizer])
